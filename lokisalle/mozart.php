...
if (!empty($_POST['commentaire']) AND !empty($_POST['note'])) {
  ...
  $req->execute([$user_id, '2', $_POST['commentaire'], $_POST['note']]);

  $_SESSION['flash']['success'] .= "Votre avis a bien été posté ! <br>";

  header('Location: mozart.php?etat=<?= implode(",", $p[1]); ?>&id_produit=2');
  ...
  <div class="row mx-auto">
    ...
    <div class="col-lg-9 bg-dark text-light">
      ...
      <div class="card mt-4 bg-dark text-light">
        <img class="card-img-top img-fluid" src="images/mozart.jpg" alt="salle mozart">
        <div class="card-body bg-dark text-light">
          <h3 class="card-title">Mozart</h3>
          <div class="description">
              <h4>place : 5</h4>
              <h4>75008 - Paris</h4>
              <p class="font-weight-bold">17 rue de turbigo</p>
          </div>
        ...
        <form action="" method="post">
          ...
          <form action="" method="post">
              ...
              <select class="custom-select mr-sm-2" name="date_arrivee" id="inlineFormCustomSelect">
                ...
                <option value='2021-01-01 08:00:00' selected>2021-01-01 08:00:00 </option>
            ...
            <div class="form-group my-4">
              ...
              <select class="custom-select mr-sm-2" name="date_depart" id="inlineFormCustomSelect2">
                ...
                <option value='2021-01-16 17:00:00' selected>2021-01-16 17:00:00</option>
