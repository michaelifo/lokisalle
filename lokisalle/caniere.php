...
if (!empty($_POST['commentaire']) AND !empty($_POST['note'])) {
  ...
  $req->execute([$user_id, '7', $_POST['commentaire'], $_POST['note']]);

  $_SESSION['flash']['success'] .= "Votre avis a bien été posté ! <br>";

  header('Location: caniere.php?etat=<?= implode(",", $p[5]); ?>&id_produit=6');
          ...
          <form action="" method="post">
            <div class="offres">
                ...
                <select class="custom-select mr-sm-2" name="date_arrivee" id="inlineFormCustomSelect">
                  ...
                  <option value='2021-06-01 08:00:00' selected>2021-06-01 08:00:00 </option>
              ...
              <div class="form-group my-4">
                ...
                <select class="custom-select mr-sm-2" name="date_depart" id="inlineFormCustomSelect2">
                  ...
                  <option value='2021-06-16 17:00:00' selected>2021-06-16 17:00:00</option>
