            ...
            <div class="offres">
                ...
                <form action="" method="post">
                    <div class="form-group">
                        ...
                        <label for="">
                            Du 01/04/2021 à 08h00 <br>
                            au 06/04/2021 à 17h00
                        </label>
                        <div class="price">
                            <br>
                            <p class="font-weight-bold">1050 €</p>
                        </div>
                        <hr>
                    </div>
                    <div class="form-group">
                        ...
                        <label for="">
                            Du 10/04/2021 à 08h00 <br>
                            au 16/04/2021 à 17h00
                        </label>
                        <div class="price">
                            <br>
                            <p class="font-weight-bold">1250 €</p>
                        </div>
                        <hr>
                    </div>
                    <div class="form-group">
                    <input type="radio" name="offer_third" class="form-check-inline">
                        <label for="">
                            Du 20/04/2021 à 08h00 <br>
                            au 24/04/2021 à 17h00
                        </label>
                        <div class="price">
                            <br>
                            <p class="font-weight-bold">850 €</p>
                        </div>
                        <hr>
                    </div>  
                </form>
