...
if (!empty($_POST['commentaire']) AND !empty($_POST['note'])) {
  ...
  $req->execute([$user_id, '4', $_POST['commentaire'], $_POST['note']]);

  $_SESSION['flash']['success'] .= "Votre avis a bien été posté ! <br>";

  header('Location: voltaire.php?etat=<?= implode(",", $p[3]); ?>&id_produit=4');
    ...
    <div class="row mx-auto">
      ...
      <div class="col-lg-9 bg-dark text-light">
        ...
        <div class="card mt-4 bg-dark text-light">
          <img class="card-img-top img-fluid" src="images/voltaire.jpg" alt="salle voltaire">
         <div class="card-body bg-dark text-light">
            <h3 class="card-title">Voltaire</h3>
            <div class="description">
                <h4>place : 9</h4>
                <h4>13001 - Marseille</h4>
                <p class="font-weight-bold">5 rue du ciel</p>
            </div>
          ...
          <form action="" method="post">
            <div class="offres">
                ...
                <select class="custom-select mr-sm-2" name="date_arrivee" id="inlineFormCustomSelect">
                  ...
                  <option value='2021-04-01 08:00:00' selected>2021-04-01 08:00:00 </option>
              ...
              <div class="form-group my-4">
                ...
                <select class="custom-select mr-sm-2" name="date_depart" id="inlineFormCustomSelect2">
                  ...
                  <option value='2021-04-16 17:00:00' selected>2021-04-16 17:00:00</option>
